...
//PARA RECIBIR
data class Autenticar(val AsignadoVisto:String, val CambioPassword: String, val Codigo: Int, val Directriz:String, val Escopeta: String, val FechaContacto: String, val FechaPosicionamiento:String, val FechaSalida:String,
                    val FechaSolicitada:String, val LugarInicio:String, val LugarSalida:String, val Marchamo: String, val MarchamoFiscal: String,
                      ...
                      var Rui:Int, val Sellado: String, val Success: String, val TelefonoEmergencia:String, val TelefonoPiloto: String, val TelefonoTransporte: String, val Token: String, val TotalServiciosApp: String,

...
//PARA RECIBIR
data class Autenticar(val AsignadoVisto:String, val CambioPassword: String, val Escopeta: String, val LugarInicio:String, val Marchamo: String, val MarchamoFiscal: String,
                      ...
                      val Rui:String, val Sellado: String, val Success: String, val TelefonoEmergencia:String, val TelefonoPiloto: String, val Token: String, val TotalServiciosApp: String,
